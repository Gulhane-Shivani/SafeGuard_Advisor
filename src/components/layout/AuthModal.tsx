            ...
            <div className="flex gap-2 mb-4">
              <button
                ...
                className={cn(
                  ...
                  !usePhone ? "bg-slate-900 text-white border-slate-900" : "bg-slate-50 text-slate-500 border-slate-100 hover:bg-slate-100"
                )}
              >
                Email
              </button>
            ...
            {usePhone ? (
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center gap-1">
                  ...
                  <span className="text-xs font-bold text-slate-400 ml-1">+91</span>
                </div>
                <input
                  type="tel"
                  ...
                  className="w-full pl-20 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-teal-600/20 focus:border-teal-600/50 transition-all text-slate-900"
                />
              </div>
            ) : (
              <>
