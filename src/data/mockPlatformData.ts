...
export const INITIAL_DATA = {
  ...
  leads: [
    { id: 1, name: 'Amit Sharma', email: 'amit@email.com', phone: '+91 98765-43210', status: 'Hot', type: 'Life Insurance', source: 'Website', assignedTo: 2, createdAt: '2026-05-01' },
    { id: 2, name: 'Priya Patel', email: 'priya@email.com', phone: '+91 98765-43211', status: 'Warm', type: 'Health Insurance', source: 'Referral', assignedTo: 2, createdAt: '2026-05-02' },
    { id: 3, name: 'Rajesh Kumar', email: 'rajesh@email.com', phone: '+91 98765-43212', status: 'Cold', type: 'Motor Insurance', source: 'LinkedIn', assignedTo: null, createdAt: '2026-05-03' },
    { id: 4, name: 'Sanjay Dutt', email: 'sanjay.d@email.com', phone: '+91 98765-43213', status: 'Hot', type: 'Health Insurance', source: 'Website', assignedTo: 2, createdAt: '2026-05-04' },
    { id: 5, name: 'Alia Bhatt', email: 'alia.b@email.com', phone: '+91 98765-43214', status: 'Warm', type: 'Life Insurance', source: 'Referral', assignedTo: 2, createdAt: '2026-05-05' },
    { id: 6, name: 'Ranbir Kapoor', email: 'ranbir.k@email.com', phone: '+91 98765-43215', status: 'Cold', type: 'Motor Insurance', source: 'Social Media', assignedTo: 2, createdAt: '2026-05-01' },
  ],
  policies: [
    ...
    { id: 3, policyNumber: 'SG-MOTR-003', customerName: 'Ramesh Patel', type: 'Motor Insurance', status: 'Renewal Due', premium: '₹15,000', startDate: '2026-04-10', endDate: '2027-04-10', agentId: 2 },
    { id: 4, policyNumber: 'SG-LIFE-004', customerName: 'Anjali Desai', type: 'Life Insurance', status: 'Reminder Sent', premium: '₹95,000', startDate: '2026-05-03', endDate: '2027-05-03', agentId: 2 },
    ...
    { id: 7, policyNumber: 'SG-LIFE-007', customerName: 'Priya Patel', type: 'Life Insurance', status: 'Reminder Sent', premium: '₹1,50,000', startDate: '2026-04-12', endDate: '2027-04-12', agentId: 3 },
  ],
  claims: [
