...
import { Shield, Target, TrendingUp, CheckCircle2, ArrowRight, Star, Plus, Minus, CheckCircle } from 'lucide-react';
            ...
            {faqs.map((faq, i) => (
                <div
                  ...
                  className={cn(
                    ...
                    openFaq === i
                      ? "bg-white border-purple-100 shadow-xl shadow-purple-600/5"
                ...
                >
                  ...
                  >
                    ...
                    <div className={cn(
                      ...
                      openFaq === i ? "bg-purple-600 text-white rotate-180" : "bg-white text-slate-400"
                    )}>
